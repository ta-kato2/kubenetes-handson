 ...
 */
package dev.mobile.local.unit.mock;

import java.util.List;

import org.dbflute.jdbc.ClassificationMeta;
import org.dbflute.optional.OptionalThing;
import dev.mobile.local.mylasta.direction.LocomocoFwAssistantDirector;
import dev.mobile.local.mylasta.direction.sponsor.LocomocoApiFailureHook;
import dev.mobile.local.mylasta.direction.sponsor.LocomocoListedClassificationProvider;
 ...
 * @author jflute
 */
public class MockLocomocoFwAssistantDirector extends LocomocoFwAssistantDirector {
    ...
    protected ListedClassificationProvider createListedClassificationProvider() {
        return new LocomocoListedClassificationProvider() {
    ...
    protected ApiFailureHook createApiFailureHook() {
        return new LocomocoApiFailureHook() {
