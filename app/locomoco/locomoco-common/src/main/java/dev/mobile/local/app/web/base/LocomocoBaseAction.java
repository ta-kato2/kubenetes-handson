...
import dev.mobile.local.app.logic.context.AccessContextLogic;
import dev.mobile.local.mylasta.action.LocomocoUserBean;
 ...
 * @author jflute
 */
public abstract class LocomocoBaseAction extends TypicalAction {
    ...
    //                                                                           =========
    @Override
    protected abstract OptionalThing<? extends LocomocoUserBean> getUserBean(); // to be more concrete
