 ...
 * @author jflute
 */
public class LocomocoCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = LocomocoUserTimeZoneProcessProvider.centralTimeZone;
