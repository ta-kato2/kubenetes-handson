 ...
 */
package dev.mobile.local.dbflute.bsentity.dbmeta;
...
import dev.mobile.local.dbflute.allcommon.*;
...
public class MemberDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", Integer.class, "memberId", null, true, true, true, "INT", 10, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "dev.mobile.local.dbflute.exentity.Member"; }
    public String getConditionBeanTypeName() { return "dev.mobile.local.dbflute.cbean.MemberCB"; }
    public String getBehaviorTypeName() { return "dev.mobile.local.dbflute.exbhv.MemberBhv"; }
