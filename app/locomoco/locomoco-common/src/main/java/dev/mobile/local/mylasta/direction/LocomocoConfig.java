...
import dev.mobile.local.mylasta.direction.LocomocoEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface LocomocoConfig extends LocomocoEnv {

    /** The key of the configuration. e.g. locomoco */
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends LocomocoEnv.SimpleImpl implements LocomocoConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(LocomocoConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(LocomocoConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(LocomocoConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(LocomocoConfig.APP_STANDARD_DATETIME_PATTERN);
        }

        public String getAppStandardTimePattern() {
            return get(LocomocoConfig.APP_STANDARD_TIME_PATTERN);
        }

        public String getCookieDefaultPath() {
            return get(LocomocoConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(LocomocoConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(LocomocoConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(LocomocoConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(LocomocoConfig.COOKIE_ETERNAL_EXPIRE);
        }
    }
}
