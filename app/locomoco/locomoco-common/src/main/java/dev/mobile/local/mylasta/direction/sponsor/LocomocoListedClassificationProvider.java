...
import dev.mobile.local.dbflute.allcommon.CDef;
import dev.mobile.local.dbflute.allcommon.DBCurrent;
 ...
 * @author jflute
 */
public abstract class LocomocoListedClassificationProvider extends TypicalListedClassificationProvider {
