...
import dev.mobile.local.mylasta.direction.LocomocoConfig;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface DanceEnv extends LocomocoConfig {

    /** The key of the configuration. e.g. dance-support@saw.example.com */
     ...
     * The value is, e.g. dance-support@saw.example.com <br>
     * comment: Mail Address for Dance Support
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends LocomocoConfig.SimpleImpl implements DanceEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getMailAddressSupport() {
            return get(DanceEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getServerDomain() {
            return get(DanceEnv.SERVER_DOMAIN);
        }
    }
}
