 ...
 */
public class DanceLoginAssist extends LocomocoLoginAssist<DanceUserBean, Member> // #change_it also UserBean
        implements PrimaryLoginManager { // #app_customize

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    private static final Logger logger = LoggerFactory.getLogger(DanceLoginAssist.class);
    ...
    //                                                                       =============
    @Override
    protected DanceUserBean createUserBean(Member userEntity) {
        return new DanceUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeDanceKey());
    }

    @Override
    protected void saveLoginHistory(Member member, DanceUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<DanceUserBean> getUserBeanType() {
        return DanceUserBean.class;
    }
