 ...
 */
package dev.mobile.local.mylasta.action;

import dev.mobile.local.mylasta.action.DanceLabels;
 ...
 * @author FreeGen
 */
public class DanceMessages extends DanceLabels {
     ...
     */
    @Override
    public DanceMessages addConstraintsAssertFalseMessage(String property) {
     ...
     */
    @Override
    public DanceMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsDigitsMessage(String property, String fraction, String integer) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsPatternMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsModCheckMessage(String property, String modType, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsTypeIntegerMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsTypeLongMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsTypeLocalDateMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsTypeLocalDateTimeMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addConstraintsTypeBooleanMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public DanceMessages addErrorsAppDoubleSubmitRequest(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public DanceMessages addErrorsLoginRequired(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public DanceMessages addErrorsUnknownBusinessError(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public DanceMessages addErrorsSignupAccountAlreadyExists(String property) {
        assertPropertyNotNull(property);
