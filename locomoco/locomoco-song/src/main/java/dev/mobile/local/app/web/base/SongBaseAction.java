...
import dev.mobile.local.app.web.base.login.SongLoginAssist;
import dev.mobile.local.mylasta.action.SongMessages;
 ...
 * @author iwamatsu0430
 */
public abstract class SongBaseAction extends LocomocoBaseAction implements LaValidatableApi<SongMessages> {
    ...
    @Resource
    private SongLoginAssist loginAssist;
    ...
    @Override
    protected OptionalThing<SongUserBean> getUserBean() { // application may call, overriding for co-variant
    ...
    @Override
    public ActionValidator<SongMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public SongMessages createMessages() { // application may call
        return new SongMessages(); // overriding to change return type to concrete-class
    }
}
