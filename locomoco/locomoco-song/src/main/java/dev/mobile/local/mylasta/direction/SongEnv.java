 ...
 * @author FreeGen
 */
public interface SongEnv extends LocomocoConfig {

    /** The key of the configuration. e.g. song-support@saw.example.com */
     ...
     * The value is, e.g. song-support@saw.example.com <br>
     * comment: Mail Address for Song Support
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends LocomocoConfig.SimpleImpl implements SongEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getMailAddressSupport() {
            return get(SongEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getServerDomain() {
            return get(SongEnv.SERVER_DOMAIN);
        }
    }
}
