...
import dev.mobile.local.mylasta.action.SongLabels;
 ...
 * @author FreeGen
 */
public class SongMessages extends SongLabels {
     ...
     */
    @Override
    public SongMessages addConstraintsAssertFalseMessage(String property) {
     ...
     */
    @Override
    public SongMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsDigitsMessage(String property, String fraction, String integer) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsPatternMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsModCheckMessage(String property, String modType, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsTypeIntegerMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsTypeLongMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsTypeLocalDateMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsTypeLocalDateTimeMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addConstraintsTypeBooleanMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public SongMessages addErrorsAppDoubleSubmitRequest(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public SongMessages addErrorsLoginRequired(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public SongMessages addErrorsUnknownBusinessError(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public SongMessages addErrorsSignupAccountAlreadyExists(String property) {
        assertPropertyNotNull(property);
