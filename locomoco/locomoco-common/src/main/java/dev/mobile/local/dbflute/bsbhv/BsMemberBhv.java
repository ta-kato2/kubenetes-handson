 ...
 */
package dev.mobile.local.dbflute.bsbhv;
...
import dev.mobile.local.dbflute.exbhv.*;
import dev.mobile.local.dbflute.bsbhv.loader.*;
import dev.mobile.local.dbflute.exentity.*;
import dev.mobile.local.dbflute.bsentity.dbmeta.*;
import dev.mobile.local.dbflute.cbean.*;
 ...
 *
 * [column]
 *     MEMBER_ID, MEMBER_NAME, REGISTER_DATETIME, REGISTER_USER, UPDATE_DATETIME, UPDATE_USER, VERSION_NO
 *
 * [sequence]
 *     
 *
