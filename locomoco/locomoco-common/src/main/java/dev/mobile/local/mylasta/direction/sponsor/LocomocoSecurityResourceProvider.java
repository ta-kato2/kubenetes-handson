 ...
 * @author jflute
 */
public class LocomocoSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public LocomocoSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
