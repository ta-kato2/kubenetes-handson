 ...
 */
package dev.mobile.local.dbflute.cbean.bs;
...
import dev.mobile.local.dbflute.allcommon.DBFluteConfig;
import dev.mobile.local.dbflute.allcommon.DBMetaInstanceHandler;
import dev.mobile.local.dbflute.allcommon.ImplementedInvokerAssistant;
import dev.mobile.local.dbflute.allcommon.ImplementedSqlClauseCreator;
import dev.mobile.local.dbflute.cbean.MemberCB;
import dev.mobile.local.dbflute.cbean.cq.MemberCQ;
...
public class BsMemberCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MemberCQ> qyCall, HpCBPurpose purpose, DBMetaProvider dbmetaProvider,
         ...
         */
        public SpecifiedColumn columnMemberId() {
            return doColumn("MEMBER_ID");
        }
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMemberName() {
            return doColumn("MEMBER_NAME");
        }
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRegisterDatetime() {
            return doColumn("REGISTER_DATETIME");
        }
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRegisterUser() {
            return doColumn("REGISTER_USER");
        }
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnUpdateDatetime() {
            return doColumn("UPDATE_DATETIME");
        }
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnUpdateUser() {
            return doColumn("UPDATE_USER");
        }
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVersionNo() {
        ...
        public HpSDRFunction<MemberCB, MemberCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MemberCB> sq, MemberCQ cq, String al, DerivedReferrerOption op) -> cq
    ...
    protected String xgetConditionBeanClassNameInternally() {
        return MemberCB.class.getName();
    }

    protected String xgetConditionQueryClassNameInternally() {
        return MemberCQ.class.getName();
    }
